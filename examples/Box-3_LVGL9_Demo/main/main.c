...
const char* greeting = "Hello. Welcome back to my project. This is Eric! You are listening to the voice of TTS. I love this so much.";
const char* greetings[] = {
    ...
    "I have to go.",
    "Talk to you soon.",
    "I'm using this device to speak.",
    "See you later.",
    "How was your day?",
...
const char* long_sentence = "There is lots of ways to be, as a person. And some people express their deep appreciation in different ways. But one of the ways that I believe people express their appreciation to the rest of humanity is to make something wonderful and put it out there.";        
...
void app_main(void)
{
  ...
  esp_codec_dev_set_out_vol(spk_codec, greeting);
